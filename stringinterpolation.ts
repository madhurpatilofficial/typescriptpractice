...
// // now if we ant to add null in the above array so it cannot of number type we have to declare it as any type...
// let newstudentMarks:any[] = [60, 70, 78, 68, null];

// let evenMarks:number[] = [];
// let oddMarks:number[] = [];
// let studentMarks:number[] = [60, 70, 78, 68, 65, 77];
...
//     }
// }
// console.log("EvenMarks: ", evenMarks);
// console.log("Odd Marks: ", oddMarks);


// Saved the particular marks according to marks

// let marks : number[] = [67,89,90,98,56,40];
// let highestMarks : number[] = [];
...
//     if (mark >=90){
//         highestMarks.push(mark);
//     }
//     else if(mark >=55 && mark <=89){
//         averageMarks.push(mark);
//     }
//     else{
//         lowMarks.push(mark);
//     }
...
// let mixedArray : (string | number)[] = ["madhur", "patil", 89]
...
// let userId: number;
// console.log(userId);  //o/p will be undefined

// let test =  (name : number, age : string)=>{
//     console.log("This is a arrow function");
//     console.log("Name: ", name);
//     console.log("Age: ", age);
// }
// test(22, "Madhur Patil");
...
//     let arr: any[] = [45, 67, 4, 3, 6, 8, 9, "madhur", 45];
//     arr.forEach((value) => {
//         {
//             if (arr != null) {
